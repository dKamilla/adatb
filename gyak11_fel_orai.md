...
```js
select title from movies_and_tv where type = 'Movie' AND release_year = 2018
          ... limit 3;
```
...
```js
alter table Szemely 
          ... add vegzetseg LIST<TEXT>;
          // először az új oszlop hozzáadása, utána updattel, és a where feltétlben a kulcs 3 oszlopa
```
